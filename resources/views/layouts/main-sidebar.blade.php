        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'paid-invoices')) }}">الفواتير المدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'unpaid-invoices')) }}">الفواتير غير
                                    المدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'partial-invoices')) }}">الفواتير المدفوعة
                                    جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'show-archieved-invoices')) }}">أرشيف
                                    الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_index')) }}">تقارير الفواتير</a></li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers_index')) }}">تقارير العملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('المستخدمين')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">المستخدمون</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
