                    ...
                    <div class="dropdown nav-item main-header-notification">
                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content bg-primary text-right">
                                ...
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك <span
                                        id="NotificationCount"
                                        class="badge badge-pill badge-warning mr-auto my-auto">{{ auth()->user()->unreadNotifications->count() }}</span>
                                    اشعارات غير مقروءة</p>
                            </div>
                            <div id="unreadNotifications">
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"
                                            href="{{ route('invoiceDetails', $notification->data['id']) }}">
