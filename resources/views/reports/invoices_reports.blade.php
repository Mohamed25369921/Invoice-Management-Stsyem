                ...
                <form action="/search_invoices" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control " name="type">
                                <option @if(old('type') == "") selected @endif value="">الكل</option>
                                <option @if(old('type') == 1) selected @endif value="1">الفواتير المدفوعة</option>
                                <option @if(old('type') == 2) selected @endif value="2">الفواتير الغير مدفوعة</option>
                                <option @if(old('type') == 3) selected @endif value="3">الفواتير المدفوعة جزئيا</option>
                        ...
                        <div class="col-lg-3" id="end_at">
                            ...
                            <div class="input-group">
                                ...
                                </div><input class="form-control fc-datepicker" value="{{ old('end_at') }}" name="end_at"
