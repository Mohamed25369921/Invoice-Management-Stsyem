...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">اهلا، مرحبا بعودتك <span class="text-primary">({{ auth()->user()->name }})</span></h2>
						  <p class="mg-b-0">برنامج ادارة الفواتير</p>
						</div>
					</div>
