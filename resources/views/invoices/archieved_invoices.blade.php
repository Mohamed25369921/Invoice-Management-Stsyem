        ...
        <div class="col-xl-12">
            ...
            <div class="modal" id="delete_invoice">
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <form action="{{ route('destroy_archieved_invoice') }}" method="POST" autocomplete="off">
                            @csrf
            ...
            <div class="modal" id="Transfer_invoice">
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">الغاء أرشفة الفاتورة</h6><button aria-label="Close" class="close"
                                data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                        </div>
                        <form action="{{ route('unarchieve_invoice') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="modal-body">
                                <p>هل انت متاكد من الغاء أرشفة الفاتورة ؟</p>
                                <input type="hidden" name="invoice_id" id="invoice_id" value="">
                            </div>
                            <div class="modal-footer">
