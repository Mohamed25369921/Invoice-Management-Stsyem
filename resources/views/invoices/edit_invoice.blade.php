                    ...
                    <form  action="{{ route('invoices.update', $invoice->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" id="due_date"
                            ...
                            <div class="col">
                                ...
                                <select name="section_id" id="section_id" class="form-control SlectBox">
                                    ...
                                    @foreach ($sections as $section)
                                        <option @if (old('section_id', $section->id) == $invoice->section->id) selected @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="rate_vat" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option @if (old('rate_vat', $invoice->rate_vat) == 5) selected @endif value="5">5%</option>
                                    <option @if (old('rate_vat', $invoice->rate_vat) == 10) selected @endif value="10">10%</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ old('total', $invoice->total) }}"
